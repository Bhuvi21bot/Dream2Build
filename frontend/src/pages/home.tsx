...
const ENTRY_POINTS: EntryPoint[] = [
  { key: "scratch", icon: PenTool, image: scratchImg, label: "Start from scratch", copy: "A blank canvas and full control.", description: "Open a completely empty 2D canvas and draw your own walls, rooms, and openings from a grid.", bullets: ["Full control over every wall, door, and window", "Snap-to-grid drawing tools", "Switch to 3D anytime to check scale"], href: "/planner" },
